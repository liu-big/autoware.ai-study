...
#include "autoware_msgs/SiteStatus.h"
...
protected:
  ...
  PlannerHNS::WayPoint m_ChargingSite;
  PlannerHNS::WayPoint m_EndSite;
  bool m_bEndSiteFlag;
...
private:
  ...
  bool m_bStartPlan;
  autoware_msgs::SitePoseArray m_SiteArray;
  autoware_msgs::SiteStatus m_SiteSatus;
  ros::Timer _timer;
  ...
  void callbackGetBatteryState(const sensor_msgs::BatteryStateConstPtr &msg);
  void callbackGetMultiGoalPose(const autoware_msgs::SitePoseArrayConstPtr & msg);
  void callbackGetStartPose(const geometry_msgs::PoseWithCovarianceStampedConstPtr &input);
  void callbackGetGoalOn(const std_msgs::BoolConstPtr &msg);
