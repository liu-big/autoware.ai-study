...
/*************************修改***********************/
            ...
            // int rowIdn = laserCloudIn->points[i].ring;//修改成自己的数据
/***************************修改****************************/
            // 计算竖直方向上的角度（雷达的第几线）
            ...
            // int rowIdn = (verticalAngle + 30.67) / (41.33/float(32-1));
/****************************修改***************************/
            ...
            thisPoint = deskewPoint(&thisPoint, relTime);//修改
