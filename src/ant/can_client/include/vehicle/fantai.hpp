...
class FantaiVehicle : public VehicleInferface
{
public:
    FantaiVehicle();
    ~FantaiVehicle();
...
private:
    ...
    ros::Publisher can_info_pub_, can_box_pub_, real_velocity_pub_, twist_pub_, batter_state_pub_;
    ros::Subscriber current_velocity_sub_,spd_ratio_sub, vehicle_raw_sub_;
    ...
    uint8_t set_mode, remote_mode = 1;
    bool dev_is_ok;
    double base_brake_value;
    int re_rotate_speed=0;
    autoware_msgs::VehicleCmd _remote;
    int corn_lamp_value = 0;
    int headlamp_value = 0;
