^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package can_connect
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* [Feature] Improve Hybrid A* planner (`#1594 <https://github.com/CPFL/Autoware/issues/1594>`_)
  ...
  * Fix can_connect with astar_planner library
  * Refactor can_connect by separating HAstar library and fixing coodinate system
...
1.0.0 (2016-12-22)
------------------
* Run visualization node when can_connect is launched
